...
class App1Osinstancedj(models.Model):
    name = models.CharField(max_length=100)
    ip = models.CharField(max_length=16)
    os = models.ForeignKey('App1Osmasterdj', models.DO_NOTHING)
    sshport = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'app1_osinstancedj'


class App1Osmasterdj(models.Model):
    name = models.CharField(max_length=100)
    logfilename = models.CharField(max_length=100)

    class Meta:
        managed = False
        db_table = 'app1_osmasterdj'


class App1Resultserver(models.Model):
    osinstance_id = models.IntegerField()
    searchid_id = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'app1_resultserver'


class App1Searchid(models.Model):
    searchedby = models.CharField(max_length=100)
    searchdate = models.DateTimeField()

    class Meta:
        managed = False
        db_table = 'app1_searchid'


class App1Searchwords(models.Model):
    name = models.CharField(max_length=100)

    class Meta:
        managed = False
        db_table = 'app1_searchwords'
